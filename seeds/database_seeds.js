...
db.serialize(() => {
    ...
    db.run(`
        ...
        VALUES ('Centrum', 'Multivitamin - 30 pcs', 'Multigummies', 1400, 1290, 10.0, 10,
                'This is benefits placeholder', 'This is overview placeholder', 'Both', '30 pcs', '119269')`, (err) => {
        if (err) {
            console.error(err.message);
        }
    });
